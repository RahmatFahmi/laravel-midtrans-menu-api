!(function () {
        ...
        document.getElementById("header-lang-img") &&
            ("en" == e
                ? (document.getElementById("header-lang-img").src =
                      window.Laravel.asset_url + "assets/images/flags/us.svg")
                : "sp" == e
                  ? (document.getElementById("header-lang-img").src =
                        window.Laravel.asset_url +
            ...
            (e = new XMLHttpRequest()).open(
                "GET",
                window.Laravel.asset_url + "assets/lang/" + a + ".json",
            ),
    ...
    function r() {
        ...
        var e = document.documentElement.clientWidth,
            e =
                (e < 1025 && 767 < e
                    ? (document.body.classList.remove("twocolumn-panel"),
                      "twocolumn" == localStorage.getItem("data-layout") &&
                          ...
                          u(),
                          s()),
                      "vertical" == localStorage.getItem("data-layout") &&
                          document.documentElement.setAttribute(
                              "data-sidebar-size",
                              "sm",
                          ),
                      "semibox" == localStorage.getItem("data-layout") &&
                          document.documentElement.setAttribute(
                              "data-sidebar-size",
                              "sm",
                          ),
                    ...
                    : 1025 <= e
                      ...
                      : e <= 767 &&
                        ...
                        "twocolumn" == localStorage.getItem("data-layout") &&
                            ...
                            y("vertical"),
                            s()),
                        "horizontal" != localStorage.getItem("data-layout") &&
                            document.documentElement.setAttribute(
                                "data-sidebar-size",
                                "lg",
                            ),
                        ...
                        Array.from(e).forEach(function (e) {
                            e.addEventListener("click", function () {
                                (document.body.classList.remove(
                                    ...
                                    "twocolumn" ==
                                    localStorage.getItem("data-layout")
        ...
        if (e == e) {
            switch (e["data-theme"]) {
                ...
                case "minimal":
                    (T("data-theme", "minimal"),
                        localStorage.setItem("data-theme", "minimal"),
                        document.documentElement.setAttribute(
                            "data-theme",
                            "minimal",
                        ));
                ...
                case "saas":
                    (T("data-theme", "saas"),
                        localStorage.setItem("data-theme", "saas"),
                        document.documentElement.setAttribute(
                            "data-theme",
                            "saas",
                        ));
                ...
                case "corporate":
                    (T("data-theme", "corporate"),
                        localStorage.setItem("data-theme", "corporate"),
                        document.documentElement.setAttribute(
                            "data-theme",
                            "corporate",
                        ));
                ...
                case "galaxy":
                    (T("data-theme", "galaxy"),
                        localStorage.setItem("data-theme", "galaxy"),
                        document.documentElement.setAttribute(
                            "data-theme",
                            "galaxy",
                        ),
                ...
                case "creative":
                    (T("data-theme", "creative"),
                        localStorage.setItem("data-theme", "creative"),
                        document.documentElement.setAttribute(
                            "data-theme",
                            "creative",
                        ));
                ...
                case "modern":
                    (T("data-theme", "modern"),
                        localStorage.setItem("data-theme", "modern"),
                        document.documentElement.setAttribute(
                            "data-theme",
                            "modern",
                        ));
                ...
                case "interactive":
                    (T("data-theme", "interactive"),
                        localStorage.setItem("data-theme", "interactive"),
                        document.documentElement.setAttribute(
                            "data-theme",
                            "interactive",
                        ));
                ...
                case "classic":
                    (T("data-theme", "classic"),
                        localStorage.setItem("data-theme", "classic"),
                        document.documentElement.setAttribute(
                            "data-theme",
                            "classic",
                        ));
                ...
                case "vintage":
                    (T("data-theme", "vintage"),
                        localStorage.setItem("data-theme", "vintage"),
                        document.documentElement.setAttribute(
                            "data-theme",
                            "vintage",
                        ));
            ...
            switch (
                ...
                case "detached":
                    ...
                    break;
                default:
                    "detached" == localStorage.getItem("data-layout-style")
                        ? (T("data-layout-style", "detached"),
                          localStorage.setItem("data-layout-style", "detached"),
                          document.documentElement.setAttribute(
                              "data-layout-style",
            ...
            switch (e["data-sidebar-size"]) {
                ...
                case "sm-hover":
                    ...
                    break;
                default:
                    "sm" == localStorage.getItem("data-sidebar-size")
                        ? (document.documentElement.setAttribute(
                              "data-sidebar-size",
                              "sm",
                          ),
                          T("data-sidebar-size", "sm"),
                          localStorage.setItem("data-sidebar-size", "sm"))
                        : "md" == localStorage.getItem("data-sidebar-size")
                          ? (document.documentElement.setAttribute(
                                "data-sidebar-size",
                                "md",
                            ),
            ...
            switch (e["data-bs-theme"]) {
                ...
                default:
                    ...
                    "dark" == localStorage.getItem("data-bs-theme")
                        ? (localStorage.setItem("data-bs-theme", "dark"),
                          document.documentElement.setAttribute(
                              "data-bs-theme",
                              "dark",
            ...
            switch (e["data-layout-width"]) {
                ...
                case "boxed":
                    ...
                    break;
                default:
                    "boxed" == localStorage.getItem("data-layout-width")
                        ? (localStorage.setItem("data-layout-width", "boxed"),
                          document.documentElement.setAttribute(
                              "data-layout-width",
                              "boxed",
            ...
            switch (e["data-sidebar"]) {
                ...
                default:
                    ...
                    "light" == localStorage.getItem("data-sidebar")
                        ? (localStorage.setItem("data-sidebar", "light"),
                          T("data-sidebar", "light"),
                          document.documentElement.setAttribute(
                              "data-sidebar",
                        ...
                        : "dark" == localStorage.getItem("data-sidebar")
                          ...
                          : "gradient" == localStorage.getItem("data-sidebar")
                            ? (localStorage.setItem("data-sidebar", "gradient"),
                              T("data-sidebar", "gradient"),
                              document.documentElement.setAttribute(
                                  "data-sidebar",
            ...
            switch (e["data-sidebar-image"]) {
                ...
                case "img-4":
                    ...
                    break;
                default:
                    localStorage.getItem("data-sidebar-image") &&
                    "none" == localStorage.getItem("data-sidebar-image")
                        ? (localStorage.setItem("data-sidebar-image", "none"),
                          T("data-sidebar-image", "none"),
                          document.documentElement.setAttribute(
                              "data-sidebar-image",
                        ...
                        : "img-1" == localStorage.getItem("data-sidebar-image")
                          ? (localStorage.setItem(
                                "data-sidebar-image",
                                "img-1",
                            ),
            ...
            switch (e["data-layout-position"]) {
                ...
                case "scrollable":
                    ...
                    break;
                default:
                    localStorage.getItem("data-layout-position") &&
                    "scrollable" == localStorage.getItem("data-layout-position")
                        ? (T("data-layout-position", "scrollable"),
                          localStorage.setItem(
                              "data-layout-position",
                              "scrollable",
            ...
            switch (e["data-preloader"]) {
                ...
                default:
                    ...
                    "disable" == localStorage.getItem("data-preloader")
                        ? (T("data-preloader", "disable"),
                          localStorage.setItem("data-preloader", "disable"),
                          document.documentElement.setAttribute(
                              "data-preloader",
                        ...
                        : "enable" == localStorage.getItem("data-preloader")
                          ? (T("data-preloader", "enable"),
                            localStorage.setItem("data-preloader", "enable"),
                            document.documentElement.setAttribute(
                                "data-preloader",
            ...
            switch (e["data-theme-colors"]) {
                ...
                case "green":
                    (T("data-theme-colors", "green"),
                        localStorage.setItem("data-theme-colors", "green"),
                        document.documentElement.setAttribute(
                            "data-theme-colors",
                            "green",
                        ));
                ...
                case "purple":
                    (T("data-theme-colors", "purple"),
                        localStorage.setItem("data-theme-colors", "purple"),
                        document.documentElement.setAttribute(
                            "data-theme-colors",
                            "purple",
                        ));
                ...
                case "blue":
                    (T("data-theme-colors", "blue"),
                        localStorage.setItem("data-theme-colors", "blue"),
                        document.documentElement.setAttribute(
                            "data-theme-colors",
                            "blue",
                        ));
            ...
            switch (e["data-body-image"]) {
                ...
                case "none":
                    ...
                    break;
                default:
                    localStorage.getItem("data-body-image") &&
                    "img-1" == localStorage.getItem("data-body-image")
                        ? (localStorage.setItem("data-body-image", "img-1"),
                          T("data-body-image", "img-1"),
                          document.documentElement.setAttribute(
                              "data-body-image",
                        ...
                        : "img-2" == localStorage.getItem("data-body-image")
                          ? (localStorage.setItem("data-body-image", "img-2"),
                            T("data-body-image", "img-2"),
                            document.documentElement.setAttribute(
                                "data-body-image",
                          ...
                          : "img-3" == localStorage.getItem("data-body-image")
                            ? (localStorage.setItem("data-body-image", "img-3"),
                              T("data-body-image", "img-3"),
                              document.documentElement.setAttribute(
                                  "data-body-image",
                ...
                (e == a.value ? (a.checked = !0) : (a.checked = !1),
                    a.addEventListener("change", function () {
                        (document.documentElement.setAttribute(n, a.value),
                            localStorage.setItem(n, a.value),
                            o(),
                ...
                : (e.querySelector(".view-all") &&
                  ...
                  e.querySelector(".empty-notification-elem") ||
                      (e.innerHTML +=
                          ...
                          window.Laravel.asset_url +
                          'assets/images/svg/bell.svg" class="img-fluid" alt="user-pic">\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t<div class="text-center pb-5 mt-2">\t\t\t\t\t\t\t\t<h6 class="fs-18 fw-semibold lh-base">Hey! You have no any notifications </h6>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t</div>'));
        });
    }
    function P() {
        var e;
    ...
    (localStorage.getItem("defaultAttribute")
        ? (((h = {})["data-layout"] = localStorage.getItem("data-layout")),
          (h["data-sidebar-size"] = localStorage.getItem("data-sidebar-size")),
          (h["data-bs-theme"] = localStorage.getItem("data-bs-theme")),
          (h["data-layout-width"] = localStorage.getItem("data-layout-width")),
          (h["data-sidebar"] = localStorage.getItem("data-sidebar")),
          (h["data-sidebar-image"] =
              localStorage.getItem("data-sidebar-image")),
          (h["data-layout-position"] = localStorage.getItem(
              "data-layout-position",
          )),
          (h["data-layout-style"] = localStorage.getItem("data-layout-style")),
          (h["data-topbar"] = localStorage.getItem("data-topbar")),
          (h["data-preloader"] = localStorage.getItem("data-preloader")),
          (h["data-body-image"] = localStorage.getItem("data-body-image")),
          (h["data-theme"] = localStorage.getItem("data-theme")),
          (h["data-theme-colors"] = localStorage.getItem("data-theme-colors")),
          e(h))
        : ((L = document.documentElement.attributes),
          ...
          Array.from(L).forEach(function (e) {
              ...
              e &&
                  ...
                  ((t = e.nodeName),
                  (h[t] = e.nodeValue),
                  localStorage.setItem(t, e.nodeValue));
          }),
          localStorage.setItem("defaultAttribute", JSON.stringify(h)),
          e(h),
